...
# Ham detect person và bus tu anh input
...
while vid.isOpened():
    ...
    for person in old_trackers:
        ...
        new_obj = dict()
        new_obj['tracker_id'] = person['tracker_id']
    ...
    cv2.putText(frame, "person number: " + str(person_number), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255 , 0), 2)
